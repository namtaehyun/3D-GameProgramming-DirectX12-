	...
	*pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	...
	m_pAirplaneMesh[1] = new CAirplaneMeshDiffused(pd3dDevice, pd3dCommandList, 20.0f,
		20.0f, 4.0f, XMFLOAT4(0.5f, 0.0f, 0.0f, 0.0f));
	m_pAirplaneMesh[2] = new CAirplaneMeshDiffused(pd3dDevice, pd3dCommandList, 20.0f,
		20.0f, 4.0f, XMFLOAT4(0.5f, 0.0f, 0.5f, 0.0f));
...
void CAirplanePlayer::ChangeRedModel()
{
	m_pMesh=m_pAirplaneMesh[1];
}

void CAirplanePlayer::ChangeGreenModel()
{
	m_pMesh=m_pAirplaneMesh[0];
}
void CAirplanePlayer::ChangeMagentaModel()
{
	m_pMesh = m_pAirplaneMesh[2];
}
...
void CAirplanePlayer::TargetTo(XMFLOAT3& xmf3LookAt, XMFLOAT3& xmf3Up)
{
